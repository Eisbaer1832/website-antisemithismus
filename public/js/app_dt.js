...
document.getElementById("click3").onclick = function() {
    document.querySelector('#content3').scrollIntoView({
        behavior: 'smooth'
    });
}
...
document.getElementById("click6").onclick = function() {
    document.querySelector('#content6').scrollIntoView({
        behavior: 'smooth'
    });
}

document.getElementById("click7").onclick = function() {
    document.querySelector('#content7').scrollIntoView({
        behavior: 'smooth'
    });
}

document.getElementById("click8").onclick = function() {

    document.querySelector('#content8').scrollIntoView({
        behavior: 'smooth'
    });
}

document.getElementById("click9").onclick = function() {
    document.querySelector('#content9').scrollIntoView({
        behavior: 'smooth'
    });
}
...
document.getElementById("click11").onclick = function() {
    document.querySelector('#content11').scrollIntoView({
        behavior: 'smooth'
    });
}
function to_top()
